...
app.controller("rightHandController", function($scope) {
    $scope.rightContent = [
        ...
        {title: "The New Plan...", href: "pages/09272016-new-plan.html", description: "Changing to one book a month, and adding 1 language a month", publishdate: "09/26/2016 21:06:30"}
        ];
});
